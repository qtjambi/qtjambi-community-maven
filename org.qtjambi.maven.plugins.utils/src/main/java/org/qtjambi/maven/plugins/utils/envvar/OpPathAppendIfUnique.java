...
public class OpPathAppendIfUnique extends OperationBase implements EnvironmentOperation, EnvironmentPathOperation {
	public OpPathAppendIfUnique() {
	}
	public OpPathAppendIfUnique(String value) {
		super(value);
	}
	...
	public static String[] operationPathStatic(String key, String[] oldValue, String newValue) {
		if(oldValue != null) {
			if(Utils.stringArrayContains(oldValue, newValue) == false)
				return Utils.stringArrayAppend(oldValue, newValue);
			return oldValue;
		} else {
